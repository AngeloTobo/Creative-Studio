export const TRUSTED_LTX_25_I2V_GRAPH_FIXTURE: Record<string, unknown> = {
  "75": {
    "inputs": {
  ...
  "398:373": {
    "inputs": {
      "text": "A reflective figure turns through violet light while the camera moves with deliberate calm.",
      "clip": [
        "398:387",
        0
      ]
