  ...
  return <div className="media-view fade-up">
    <section className="media-upload glass">
      ...
      <label className="training-consent">
        ...
        <span><strong>Eligible for future training</strong><small>Records your consent and asset lineage. Uploading does not start a training job.</small></span>
      </label>
    ...
    <section className="media-library">
      <div className="media-library-head"><div><span className="eyebrow">Retained library</span><h2>Your source assets</h2></div><button className="btn btn-ghost" onClick={onGenerate}><Icon name="generate" size={16} /> Open generation</button></div>
