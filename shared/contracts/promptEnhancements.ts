...
export type VideoPromptEnhancement = {
  ...
  provider: "local-comfyui" | "local-lmstudio";
...
export type VideoPromptEnhancementStamp = {
  ...
  provider: "local-comfyui" | "local-lmstudio";
  workflowId: "gemma4-video-prompt-enhancer" | "lmstudio-video-prompt-enhancer";
  workflowVersion: 1;
  model: string;
  comfyPromptId: string | null;
  upstreamId?: string;
...
export type RunnerCompletePromptEnhancementRequest = { enhancedPrompt: string; comfyPromptId?: string; upstreamId?: string; helperModel?: string };
